      ...
      <Navbar bg="white" expand="lg" sticky='top' expanded={state}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-auto fw-semibold">
            <Nav.Link href="#home" onClick={state && toggle}>Home</Nav.Link>
            <Nav.Link href="#create" onClick={state && toggle}>Top Sales</Nav.Link>
            <Nav.Link href="#collections" onClick={state && toggle}>Collections</Nav.Link>
            <Nav.Link href="#blog" onClick={state && toggle}>Our Blog</Nav.Link>
            <Nav.Link href="#about" onClick={state && toggle}>About Us</Nav.Link>
          </Nav>
          <Nav className="ml-auto fw-semibold d-flex align-items-center">
            ...
            <Nav.Link href="#profile" className="ml-2" onClick={state && toggle}>Sign Up</Nav.Link>
            <div className="vr ms-3 ms-lg-1 mx-3 align-self-center rounded divider"></div>
            <Button variant="outline-dark" className="ml-2 btn-neutral-800 rounded-5 connect" onClick={state && toggle}>Connect Wallet</Button>
            </div>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
