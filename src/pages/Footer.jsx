...
const Footer = () => {
  return (
    ...
    <Container className="justify-content-center">
      ...
      <Row className="justify-content-between align-items-center py-3 row-gap-2">
        ...
        <Col xs={12} md={6} className="d-flex justify-content-center justify-content-md-end px-0">
          <ul className="list-unstyled d-flex mb-0 fw-medium">
            <li className="mx-2 "><a href="#privacy" className="text-neutral-400 text-decoration-none">Privacy</a></li>
            <li className="mx-2"><a href="#terms" className="text-neutral-400 text-decoration-none">Terms & Conditions</a></li>
            <li className="mx-2"><a href="#about" className="text-neutral-400 text-decoration-none">About Us</a></li>
          </ul>
        </Col>
      </Row>
    </Container>
