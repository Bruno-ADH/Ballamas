      ...
      <Row className="my-5 gap-3 gap-lg-0">
          ...
          {cartItems.map(item => (
            <Row key={item.id} className="border-0 border-top border-light-gray align-items-center mb-3 pt-3">
              ...
              <Col xs={3} md={4} className='ps-0'>
                <h5 className='fm-archivo-semibold text-black product-title my-0'>{item.title}</h5>
                <p className='fm-archivo-Medium product-size text-dark-gray my-0'>{item.color} - {item.size}</p>
                <p className='fm-archivo-semibold text-black product-price my-0'>${item.price}</p>
              </Col>
        ...
        <Col md={4}>
          <div className="p-3 border border-light-gray rounded-4 p-3 px-4">
            ...
            <Button variant="dark" className="w-100 mt-2 checkout bg-black rounded-pill">Checkout now</Button>
          </div>
        </Col>
      </Row>
    </Container>
